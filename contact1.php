...
$id=$_GET['id'];
    ...
    if(isset($_POST['btn']))
    {
        ...
        $sql= "update contact set name='$uname',address='$address',email='$email',phone='$phone',msg='$Message' where id=$id";
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Contact US</h4>
                    ...
                    <div class="card-body">
                      <form method="post" >
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="John Doe" name="fname" value="<?php echo $rw[1];?>"/>
                          </div>
                        </div>
                        <div class="row mb-3">
